...
var svgWorldMap = (function() { 
    ...
    var options = {
        // Base path 
        libPath: '', // Point to library folder, e.g. (http[s]:)//myserver.com/map/src/
        // Basic options
    ...
    "Asia": "#FF5733",
    "Europe": "#3399FF",
    "North America": "#33FF57",
    "South America": "#FF3399",
    "Africa": "#FFD700",
    "Oceania": "#8A2BE2"
};

function colorMapByContinent() {
    for (const iso in countries) {
        const countryPath = countries[iso];
        const details = countryDetails[iso];

        if (details && details.continent) {
            const color = continentColors[details.continent];
            if (color) {
                // Set the color for all provinces/paths belonging to this country
                countryPath.provinces.forEach(province => {
                    province.updateColor = color;
                    pathSetAttributes(province, color);
                    if (province.provinces) {
                        province.provinces.forEach(subprovince => {
                            subprovince.updateColor = color;
                            pathSetAttributes(subprovince, color);
                        });
                    }
                });
            }
...
// *** MODIFICATION START: INITIAL COLORING ***
// colorMapByContinent();
// *** MODIFICATION END ***
    ...
    function updateInfoBox(event, path) {
        ...
        if (infoBox != undefined) {
            if (event == 'over' && path.id != 'World' && path.id != 'Ocean') {
                ...
                var details = countryDetails[countryId]; // Use the new object

                // Get Country Name
                var infoText = '<b>' + path.country.name + '</b>';

                // *** MODIFICATION START: Add Capital, Continent, and Languages ***
                if (details != undefined) {
                    if (details.capital) {
                        infoText += '<br>Capital: <b>' + details.capital + '</b>';
                    }
                    if (details.continent) {
                        infoText += '<br>Continent: <b>' + details.continent + '</b>';
                    }
                    if (details.languages) {
                        infoText += '<br>Languages: <b>' + details.languages + '</b>';
                    }
                }
                // *** MODIFICATION END ***
    ...
    // *** MODIFICATION START: NEW Data Object for Capital Cities ***
    
    var countryDetails = {
  "AD": { "capital": "Andorra la Vella", "languages": "Catalan", "continent": "Europe" },
  "AE": { "capital": "Abu Dhabi", "languages": "Arabic", "continent": "Asia" },
  "AF": { "capital": "Kabul", "languages": "Pashto, Dari", "continent": "Asia" },
  "AG": { "capital": "St. John's", "languages": "English", "continent": "North America" },
  "AI": { "capital": "The Valley", "languages": "English", "continent": "North America" },
  "AL": { "capital": "Tirana", "languages": "Albanian", "continent": "Europe" },
  "AM": { "capital": "Yerevan", "languages": "Armenian", "continent": "Asia" },
  "AO": { "capital": "Luanda", "languages": "Portuguese", "continent": "Africa" },
  "AQ": { "capital": "N/A", "languages": "N/A", "continent": "Antarctica" },
  "AR": { "capital": "Buenos Aires", "languages": "Spanish", "continent": "South America" },
  "AS": { "capital": "Pago Pago", "languages": "English, Samoan", "continent": "Oceania" },
  "AT": { "capital": "Vienna", "languages": "German", "continent": "Europe" },
  "AU": { "capital": "Canberra", "languages": "English", "continent": "Oceania" },
  "AW": { "capital": "Oranjestad", "languages": "Dutch, Papiamento", "continent": "North America" },
  "AX": { "capital": "Mariehamn", "languages": "Swedish", "continent": "Europe" },
  "AZ": { "capital": "Baku", "languages": "Azerbaijani", "continent": "Asia" },

  "BA": { "capital": "Sarajevo", "languages": "Bosnian, Serbian, Croatian", "continent": "Europe" },
  "BB": { "capital": "Bridgetown", "languages": "English", "continent": "North America" },
  "BD": { "capital": "Dhaka", "languages": "Bengali", "continent": "Asia" },
  "BE": { "capital": "Brussels", "languages": "Dutch, French, German", "continent": "Europe" },
  "BF": { "capital": "Ouagadougou", "languages": "French", "continent": "Africa" },
  "BG": { "capital": "Sofia", "languages": "Bulgarian", "continent": "Europe" },
  "BH": { "capital": "Manama", "languages": "Arabic", "continent": "Asia" },
  "BI": { "capital": "Gitega", "languages": "Kirundi, French", "continent": "Africa" },
  "BJ": { "capital": "Porto-Novo", "languages": "French", "continent": "Africa" },
  "BL": { "capital": "Gustavia", "languages": "French", "continent": "North America" },
  "BM": { "capital": "Hamilton", "languages": "English", "continent": "North America" },
  "BN": { "capital": "Bandar Seri Begawan", "languages": "Malay", "continent": "Asia" },
  "BO": { "capital": "Sucre (constitutional), La Paz (seat of government)", "languages": "Spanish, Quechua, Aymara", "continent": "South America" },
  "BQ": { "capital": "Kralendijk", "languages": "Dutch, Papiamento", "continent": "North America" },
  "BR": { "capital": "Brasília", "languages": "Portuguese", "continent": "South America" },
  "BS": { "capital": "Nassau", "languages": "English", "continent": "North America" },
  "BT": { "capital": "Thimphu", "languages": "Dzongkha", "continent": "Asia" },
  "BV": { "capital": "N/A", "languages": "N/A", "continent": "Antarctica" },
  "BW": { "capital": "Gaborone", "languages": "English, Tswana", "continent": "Africa" },
  "BY": { "capital": "Minsk", "languages": "Belarusian, Russian", "continent": "Europe" },
  "BZ": { "capital": "Belmopan", "languages": "English", "continent": "North America" },

  "CA": { "capital": "Ottawa", "languages": "English, French", "continent": "North America" },
  "CC": { "capital": "West Island", "languages": "English", "continent": "Asia" },
  "CD": { "capital": "Kinshasa", "languages": "French", "continent": "Africa" },
  "CF": { "capital": "Bangui", "languages": "French, Sango", "continent": "Africa" },
  "CG": { "capital": "Brazzaville", "languages": "French", "continent": "Africa" },
  "CH": { "capital": "Bern", "languages": "German, French, Italian, Romansh", "continent": "Europe" },
  "CI": { "capital": "Yamoussoukro", "languages": "French", "continent": "Africa" },
  "CK": { "capital": "Avarua", "languages": "English, Cook Islands Māori", "continent": "Oceania" },
  "CL": { "capital": "Santiago", "languages": "Spanish", "continent": "South America" },
  "CM": { "capital": "Yaoundé", "languages": "French, English", "continent": "Africa" },
  "CN": { "capital": "Beijing", "languages": "Mandarin", "continent": "Asia" },
  "CO": { "capital": "Bogotá", "languages": "Spanish", "continent": "South America" },
  "CR": { "capital": "San José", "languages": "Spanish", "continent": "North America" },
  "CU": { "capital": "Havana", "languages": "Spanish", "continent": "North America" },
  "CV": { "capital": "Praia", "languages": "Portuguese", "continent": "Africa" },
  "CW": { "capital": "Willemstad", "languages": "Papiamento, Dutch", "continent": "North America" },
  "CX": { "capital": "Flying Fish Cove", "languages": "English", "continent": "Asia" },
  "CY": { "capital": "Nicosia", "languages": "Greek, Turkish", "continent": "Europe" },
  "CZ": { "capital": "Prague", "languages": "Czech", "continent": "Europe" },

  "DE": { "capital": "Berlin", "languages": "German", "continent": "Europe" },
  "DJ": { "capital": "Djibouti", "languages": "French, Arabic", "continent": "Africa" },
  "DK": { "capital": "Copenhagen", "languages": "Danish", "continent": "Europe" },
  "DM": { "capital": "Roseau", "languages": "English", "continent": "North America" },
  "DO": { "capital": "Santo Domingo", "languages": "Spanish", "continent": "North America" },
  "DZ": { "capital": "Algiers", "languages": "Arabic, Tamazight", "continent": "Africa" },

  "EC": { "capital": "Quito", "languages": "Spanish", "continent": "South America" },
  "EE": { "capital": "Tallinn", "languages": "Estonian", "continent": "Europe" },
  "EG": { "capital": "Cairo", "languages": "Arabic", "continent": "Africa" },
  "EH": { "capital": "El Aaiún", "languages": "Arabic, Spanish", "continent": "Africa" },
  "ER": { "capital": "Asmara", "languages": "Tigrinya, Arabic, English", "continent": "Africa" },
  "ES": { "capital": "Madrid", "languages": "Spanish", "continent": "Europe" },
  "ET": { "capital": "Addis Ababa", "languages": "Amharic", "continent": "Africa" },

  "FI": { "capital": "Helsinki", "languages": "Finnish, Swedish", "continent": "Europe" },
  "FJ": { "capital": "Suva", "languages": "English, Fijian, Hindi", "continent": "Oceania" },
  "FK": { "capital": "Stanley", "languages": "English", "continent": "South America" },
  "FM": { "capital": "Palikir", "languages": "English, Chuukese, Pohnpeian, Kosraean, Yapese", "continent": "Oceania" },
  "FO": { "capital": "Tórshavn", "languages": "Faroese, Danish", "continent": "Europe" },
  "FR": { "capital": "Paris", "languages": "French", "continent": "Europe" },

  "GA": { "capital": "Libreville", "languages": "French", "continent": "Africa" },
  "GB": { "capital": "London", "languages": "English", "continent": "Europe" },
  "GD": { "capital": "St. George's", "languages": "English", "continent": "North America" },
  "GE": { "capital": "Tbilisi", "languages": "Georgian", "continent": "Asia" },
  "GF": { "capital": "Cayenne", "languages": "French", "continent": "South America" },
  "GG": { "capital": "St. Peter Port", "languages": "English", "continent": "Europe" },
  "GH": { "capital": "Accra", "languages": "English", "continent": "Africa" },
  "GI": { "capital": "Gibraltar", "languages": "English", "continent": "Europe" },
  "GL": { "capital": "Nuuk", "languages": "Greenlandic, Danish", "continent": "North America" },
  "GM": { "capital": "Banjul", "languages": "English", "continent": "Africa" },
  "GN": { "capital": "Conakry", "languages": "French", "continent": "Africa" },
  "GP": { "capital": "Basse-Terre", "languages": "French", "continent": "North America" },
  "GQ": { "capital": "Malabo", "languages": "Spanish, French, Portuguese", "continent": "Africa" },
  "GR": { "capital": "Athens", "languages": "Greek", "continent": "Europe" },
  "GS": { "capital": "King Edward Point", "languages": "English", "continent": "Antarctica" },
  "GT": { "capital": "Guatemala City", "languages": "Spanish", "continent": "North America" },
  "GU": { "capital": "Hagatna", "languages": "English, Chamorro", "continent": "Oceania" },
  "GW": { "capital": "Bissau", "languages": "Portuguese", "continent": "Africa" },
  "GY": { "capital": "Georgetown", "languages": "English", "continent": "South America" },

  "HK": { "capital": "Hong Kong", "languages": "Chinese (Cantonese), English", "continent": "Asia" },
  "HM": { "capital": "N/A", "languages": "N/A", "continent": "Antarctica" },
  "HN": { "capital": "Tegucigalpa", "languages": "Spanish", "continent": "North America" },
  "HR": { "capital": "Zagreb", "languages": "Croatian", "continent": "Europe" },
  "HT": { "capital": "Port-au-Prince", "languages": "French, Haitian Creole", "continent": "North America" },
  "HU": { "capital": "Budapest", "languages": "Hungarian", "continent": "Europe" },

  "ID": { "capital": "Jakarta", "languages": "Indonesian", "continent": "Asia" },
  "IE": { "capital": "Dublin", "languages": "Irish, English", "continent": "Europe" },
  "IL": { "capital": "Jerusalem", "languages": "Hebrew, Arabic", "continent": "Asia" },
  "IM": { "capital": "Douglas", "languages": "English", "continent": "Europe" },
  "IN": { "capital": "New Delhi", "languages": "Hindi, English", "continent": "Asia" },
  "IO": { "capital": "Diego Garcia", "languages": "English", "continent": "Asia" },
  "IQ": { "capital": "Baghdad", "languages": "Arabic, Kurdish", "continent": "Asia" },
  "IR": { "capital": "Tehran", "languages": "Persian (Farsi)", "continent": "Asia" },
  "IS": { "capital": "Reykjavík", "languages": "Icelandic", "continent": "Europe" },
  "IT": { "capital": "Rome", "languages": "Italian", "continent": "Europe" },

  "JE": { "capital": "Saint Helier", "languages": "English", "continent": "Europe" },
  "JM": { "capital": "Kingston", "languages": "English", "continent": "North America" },
  "JO": { "capital": "Amman", "languages": "Arabic", "continent": "Asia" },
  "JP": { "capital": "Tokyo", "languages": "Japanese", "continent": "Asia" },

  "KE": { "capital": "Nairobi", "languages": "English, Swahili", "continent": "Africa" },
  "KG": { "capital": "Bishkek", "languages": "Kyrgyz, Russian", "continent": "Asia" },
  "KH": { "capital": "Phnom Penh", "languages": "Khmer", "continent": "Asia" },
  "KI": { "capital": "Tarawa", "languages": "Gilbertese (Kiribati), English", "continent": "Oceania" },
  "KM": { "capital": "Moroni", "languages": "Arabic, French", "continent": "Africa" },
  "KN": { "capital": "Basseterre", "languages": "English", "continent": "North America" },
  "KP": { "capital": "Pyongyang", "languages": "Korean", "continent": "Asia" },
  "KR": { "capital": "Seoul", "languages": "Korean", "continent": "Asia" },
  "KW": { "capital": "Kuwait City", "languages": "Arabic", "continent": "Asia" },
  "KY": { "capital": "George Town", "languages": "English", "continent": "North America" },
  "KZ": { "capital": "Astana (Nur-Sultan)", "languages": "Kazakh, Russian", "continent": "Asia" },

  "LA": { "capital": "Vientiane", "languages": "Lao", "continent": "Asia" },
  "LB": { "capital": "Beirut", "languages": "Arabic", "continent": "Asia" },
  "LC": { "capital": "Castries", "languages": "English", "continent": "North America" },
  "LI": { "capital": "Vaduz", "languages": "German", "continent": "Europe" },
  "LK": { "capital": "Sri Jayawardenepura Kotte", "languages": "Sinhala, Tamil", "continent": "Asia" },
  "LR": { "capital": "Monrovia", "languages": "English", "continent": "Africa" },
  "LS": { "capital": "Maseru", "languages": "Sesotho, English", "continent": "Africa" },
  "LT": { "capital": "Vilnius", "languages": "Lithuanian", "continent": "Europe" },
  "LU": { "capital": "Luxembourg", "languages": "Luxembourgish, French, German", "continent": "Europe" },
  "LV": { "capital": "Riga", "languages": "Latvian", "continent": "Europe" },
  "LY": { "capital": "Tripoli", "languages": "Arabic", "continent": "Africa" },

  "MA": { "capital": "Rabat", "languages": "Arabic, Tamazight", "continent": "Africa" },
  "MC": { "capital": "Monaco", "languages": "French", "continent": "Europe" },
  "MD": { "capital": "Chișinău", "languages": "Romanian", "continent": "Europe" },
  "ME": { "capital": "Podgorica", "languages": "Montenegrin", "continent": "Europe" },
  "MF": { "capital": "Marigot", "languages": "French", "continent": "North America" },
  "MG": { "capital": "Antananarivo", "languages": "Malagasy, French", "continent": "Africa" },
  "MH": { "capital": "Majuro", "languages": "Marshallese, English", "continent": "Oceania" },
  "MK": { "capital": "Skopje", "languages": "Macedonian", "continent": "Europe" },
  "ML": { "capital": "Bamako", "languages": "French", "continent": "Africa" },
  "MM": { "capital": "Naypyidaw", "languages": "Burmese", "continent": "Asia" },
  "MN": { "capital": "Ulaanbaatar", "languages": "Mongolian", "continent": "Asia" },
  "MO": { "capital": "Macao", "languages": "Chinese (Cantonese), Portuguese", "continent": "Asia" },
  "MP": { "capital": "Saipan", "languages": "English, Chamorro", "continent": "Oceania" },
  "MQ": { "capital": "Fort-de-France", "languages": "French", "continent": "North America" },
  "MR": { "capital": "Nouakchott", "languages": "Arabic", "continent": "Africa" },
  "MS": { "capital": "Plymouth (official), Brades (de facto)", "languages": "English", "continent": "North America" },
  "MT": { "capital": "Valletta", "languages": "Maltese, English", "continent": "Europe" },
  "MU": { "capital": "Port Louis", "languages": "English, French", "continent": "Africa" },
  "MV": { "capital": "Malé", "languages": "Dhivehi", "continent": "Asia" },
  "MW": { "capital": "Lilongwe", "languages": "English, Chichewa", "continent": "Africa" },
  "MX": { "capital": "Mexico City", "languages": "Spanish", "continent": "North America" },
  "MY": { "capital": "Kuala Lumpur (official), Putrajaya (administrative)", "languages": "Malay", "continent": "Asia" },
  "MZ": { "capital": "Maputo", "languages": "Portuguese", "continent": "Africa" },

  "NA": { "capital": "Windhoek", "languages": "English", "continent": "Africa" },
  "NC": { "capital": "Nouméa", "languages": "French", "continent": "Oceania" },
  "NE": { "capital": "Niamey", "languages": "French", "continent": "Africa" },
  "NF": { "capital": "Kingston (Norfolk Island)", "languages": "English", "continent": "Oceania" },
  "NG": { "capital": "Abuja", "languages": "English", "continent": "Africa" },
  "NI": { "capital": "Managua", "languages": "Spanish", "continent": "North America" },
  "NL": { "capital": "Amsterdam", "languages": "Dutch", "continent": "Europe" },
  "NO": { "capital": "Oslo", "languages": "Norwegian", "continent": "Europe" },
  "NP": { "capital": "Kathmandu", "languages": "Nepali", "continent": "Asia" },
  "NR": { "capital": "Yaren (de facto)", "languages": "Nauruan, English", "continent": "Oceania" },
  "NU": { "capital": "Alofi", "languages": "Niuean, English", "continent": "Oceania" },
  "NZ": { "capital": "Wellington", "languages": "English, Māori", "continent": "Oceania" },

  "OM": { "capital": "Muscat", "languages": "Arabic", "continent": "Asia" },

  "PA": { "capital": "Panama City", "languages": "Spanish", "continent": "North America" },
  "PE": { "capital": "Lima", "languages": "Spanish", "continent": "South America" },
  "PF": { "capital": "Papeete", "languages": "French", "continent": "Oceania" },
  "PG": { "capital": "Port Moresby", "languages": "English", "continent": "Oceania" },
  "PH": { "capital": "Manila", "languages": "Filipino, English", "continent": "Asia" },
  "PK": { "capital": "Islamabad", "languages": "Urdu, English", "continent": "Asia" },
  "PL": { "capital": "Warsaw", "languages": "Polish", "continent": "Europe" },
  "PM": { "capital": "Saint-Pierre", "languages": "French", "continent": "North America" },
  "PN": { "capital": "Adamstown", "languages": "English", "continent": "Oceania" },
  "PR": { "capital": "San Juan", "languages": "Spanish, English", "continent": "North America" },
  "PS": { "capital": "Ramallah (administrative), East Jerusalem (claimed)", "languages": "Arabic", "continent": "Asia" },
  "PT": { "capital": "Lisbon", "languages": "Portuguese", "continent": "Europe" },
  "PW": { "capital": "Ngerulmud", "languages": "Palauan, English", "continent": "Oceania" },
  "PY": { "capital": "Asunción", "languages": "Spanish, Guaraní", "continent": "South America" },

  "QA": { "capital": "Doha", "languages": "Arabic", "continent": "Asia" },

  "RE": { "capital": "Saint-Denis", "languages": "French", "continent": "Africa" },
  "RO": { "capital": "Bucharest", "languages": "Romanian", "continent": "Europe" },
  "RS": { "capital": "Belgrade", "languages": "Serbian", "continent": "Europe" },
  "RU": { "capital": "Moscow", "languages": "Russian", "continent": "Europe" },
  "RW": { "capital": "Kigali", "languages": "Kinyarwanda, French, English", "continent": "Africa" },

  "SA": { "capital": "Riyadh", "languages": "Arabic", "continent": "Asia" },
  "SB": { "capital": "Honiara", "languages": "English", "continent": "Oceania" },
  "SC": { "capital": "Victoria", "languages": "Seychellois Creole, English, French", "continent": "Africa" },
  "SD": { "capital": "Khartoum", "languages": "Arabic, English", "continent": "Africa" },
  "SE": { "capital": "Stockholm", "languages": "Swedish", "continent": "Europe" },
  "SG": { "capital": "Singapore", "languages": "English, Malay, Mandarin, Tamil", "continent": "Asia" },
  "SH": { "capital": "Jamestown", "languages": "English", "continent": "Africa" },
  "SI": { "capital": "Ljubljana", "languages": "Slovene", "continent": "Europe" },
  "SJ": { "capital": "Longyearbyen", "languages": "Norwegian", "continent": "Europe" },
  "SK": { "capital": "Bratislava", "languages": "Slovak", "continent": "Europe" },
  "SL": { "capital": "Freetown", "languages": "English", "continent": "Africa" },
  "SM": { "capital": "San Marino", "languages": "Italian", "continent": "Europe" },
  "SN": { "capital": "Dakar", "languages": "French", "continent": "Africa" },
  "SO": { "capital": "Mogadishu", "languages": "Somali, Arabic", "continent": "Africa" },
  "SR": { "capital": "Paramaribo", "languages": "Dutch", "continent": "South America" },
  "SS": { "capital": "Juba", "languages": "English", "continent": "Africa" },
  "ST": { "capital": "São Tomé", "languages": "Portuguese", "continent": "Africa" },
  "SV": { "capital": "San Salvador", "languages": "Spanish", "continent": "North America" },
  "SX": { "capital": "Philipsburg", "languages": "Dutch, English", "continent": "North America" },
  "SY": { "capital": "Damascus", "languages": "Arabic", "continent": "Asia" },
  "SZ": { "capital": "Mbabane (administrative), Lobamba (legislative/royal)", "languages": "Swazi, English", "continent": "Africa" },

  "TC": { "capital": "Cockburn Town", "languages": "English", "continent": "North America" },
  "TD": { "capital": "N'Djamena", "languages": "French, Arabic", "continent": "Africa" },
  "TF": { "capital": "N/A", "languages": "French", "continent": "Antarctica" },
  "TG": { "capital": "Lomé", "languages": "French", "continent": "Africa" },
  "TH": { "capital": "Bangkok", "languages": "Thai", "continent": "Asia" },
  "TJ": { "capital": "Dushanbe", "languages": "Tajik", "continent": "Asia" },
  "TK": { "capital": "Fakaofo (territorial), Nukunonu, Atafu", "languages": "Tokelauan, English", "continent": "Oceania" },
  "TL": { "capital": "Dili", "languages": "Tetum, Portuguese", "continent": "Asia" },
  "TM": { "capital": "Ashgabat", "languages": "Turkmen", "continent": "Asia" },
  "TN": { "capital": "Tunis", "languages": "Arabic", "continent": "Africa" },
  "TO": { "capital": "Nukuʻalofa", "languages": "Tongan, English", "continent": "Oceania" },
  "TR": { "capital": "Ankara", "languages": "Turkish", "continent": "Asia" },
  "TT": { "capital": "Port of Spain", "languages": "English", "continent": "North America" },
  "TV": { "capital": "Funafuti", "languages": "Tuvaluan, English", "continent": "Oceania" },
  "TW": { "capital": "Taipei", "languages": "Mandarin Chinese", "continent": "Asia" },
  "TZ": { "capital": "Dodoma", "languages": "Swahili, English", "continent": "Africa" },

  "UA": { "capital": "Kyiv", "languages": "Ukrainian", "continent": "Europe" },
  "UG": { "capital": "Kampala", "languages": "English, Swahili", "continent": "Africa" },
  "UM": { "capital": "N/A", "languages": "English", "continent": "Oceania" },
  "US": { "capital": "Washington, D.C.", "languages": "English", "continent": "North America" },
  "UY": { "capital": "Montevideo", "languages": "Spanish", "continent": "South America" },
  "UZ": { "capital": "Tashkent", "languages": "Uzbek", "continent": "Asia" },

  "VA": { "capital": "Vatican City", "languages": "Italian, Latin", "continent": "Europe" },
  "VC": { "capital": "Kingstown", "languages": "English", "continent": "North America" },
  "VE": { "capital": "Caracas", "languages": "Spanish", "continent": "South America" },
  "VG": { "capital": "Road Town", "languages": "English", "continent": "North America" },
  "VI": { "capital": "Charlotte Amalie", "languages": "English", "continent": "North America" },
  "VN": { "capital": "Hanoi", "languages": "Vietnamese", "continent": "Asia" },
  "VU": { "capital": "Port Vila", "languages": "Bislama, English, French", "continent": "Oceania" },

  "WF": { "capital": "Mata-Utu", "languages": "French", "continent": "Oceania" },
  "WS": { "capital": "Apia", "languages": "Samoan, English", "continent": "Oceania" },

  "XK": { "capital": "Pristina", "languages": "Albanian, Serbian", "continent": "Europe" },

  "YE": { "capital": "Sana'a (constitutional), Aden (temporary seat declared at times)", "languages": "Arabic", "continent": "Asia" },
  "YT": { "capital": "Mamoudzou", "languages": "French", "continent": "Africa" },

  "ZA": { "capital": "Pretoria (administrative), Cape Town (legislative), Bloemfontein (judicial)", "languages": "11 official languages", "continent": "Africa" },
  "ZM": { "capital": "Lusaka", "languages": "English", "continent": "Africa" },
  "ZW": { "capital": "Harare", "languages": "English, Shona, Ndebele", "continent": "Africa" }
};
